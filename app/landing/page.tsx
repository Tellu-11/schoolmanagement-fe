      ...
      <div className='max-w-full mx-auto px-4 flex items-center justify-between border-b-1 border-red-400 py-4'>
        ...
        <div className='flex items-center space-x-4'>
          <button className='flex text-gray-600 hover:text-gray-900'>
            <Image className='m-2' src="/image/us-flag.png" alt="ID" width={24} height={24} />
            <p className='m-2'>Eng (US)</p>
          </button>
          <div className='text-gray-400'>
            |
          </div>
          <button className='text-white hover:bg-red-500 bg-red-400 px-4 py-2 rounded-lg transition-colors'>
            Sign in
          </button>
        </div>
      </div>
        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-8 items-center">
          <div className="text-center lg:text-left">
            <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
              <span className="block text-red-400 xl:inline">School Management System </span>
              <span className="block text-blue-950 md:inline">untuk Masa Depan Pendidikan</span>
            </h1>
            <p className="mt-3 text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl">
              Platform digital terpadu untuk manajemen sekolah yang efisien, modern, dan user-friendly.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="mt-3 text-xl text-gray-500 sm:m-8">
              Sistem manajemen sekolah yang memudahkan Anda mengelola berbagai aspek pendidikan Anda.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            ...
            <div className="p-6 bg-white rounded-xl shadow-lg hover:shadow-xl hover:scale-110 transition-transform duration-300">
              ...
              <p className="mt-2 text-gray-500 text-center">Kelola administrasi sekolah dengan mudah dan efisien melalui sistem yang terintegrasi.</p>
            </div>
            ...
            <div className="p-6 bg-white rounded-xl shadow-lg hover:shadow-xl hover:scale-110 transition-transform duration-300">
              ...
              <p className="mt-2 text-gray-500 text-center">Akses informasi akademik secara real-time untuk monitoring perkembangan pembelajaran.</p>
            </div>
            ...
            <div className="p-6 bg-white rounded-xl shadow-lg hover:shadow-xl hover:scale-110 transition-transform duration-300">
              ...
              <p className="mt-2 text-gray-500 text-center">Digitalisasi kegiatan sekolah untuk efisiensi dan transparansi yang lebih baik.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="mt-3 text-xl text-gray-500 sm:mt-4">
              This Academic Information System is designed to support academic processes within campus environments—ranging from student and lecturer data management, course registration (KRS), grade management, to attendance tracking and academic monitoring.
            </p>
          </div>
