...
import { getAllUsers, deleteUser, getRoles } from "./service/userService";
    ...
    <div className="p-6 bg-white rounded-xl shadow-sm border border-gray-100 w-full">
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-600 text-sm mt-1">Manage system users and their permissions</p>
        </div>
        <button
              ...
              {users.map((user, index) => (
                ...
                >
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm font-mono text-gray-900">{user.nip}</div>
                  </td>
                  ...
                  <td className="px-6 py-4">
                    <div className="flex gap-3">
                      ...
                      <button
                        ...
                        className="text-green-600 hover:text-green-800 text-sm font-medium transition-colors duration-150 flex items-center gap-1"
                      >
                      ...
                      <button
                        ...
                        className="text-red-600 hover:text-red-800 text-sm font-medium transition-colors duration-150 flex items-center gap-1 disabled:opacity-50"
                      >
            ...
            <div className="px-6 py-4 space-y-4 max-h-96 overflow-y-auto">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="mt-1 text-sm font-mono text-gray-900">{selectedUser.nip}</p>
                </div>
                <div>
              ...
              <div className="border-t border-gray-200 pt-4">
                ...
                <div className="grid grid-cols-2 gap-4 text-xs">
                  <div>
                    ...
                    <p className="text-gray-900">{selectedUser.createdBy.name}</p>
                  </div>
                  <div>
                    <label className="font-medium text-gray-500">Updated By</label>
                    <p className="text-gray-900">{selectedUser.updatedBy.name}</p>
                  </div>
                  <div>
